            ...
            <div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            {!!Form::open(['route' =>['aplikan.update',$aplikan], 'class' => 'form-horizontal','enctype' => 'multipart/form-data'])!!}
                            <div class="box-body">
                              <div class='form-group{{$errors->has('nama') ? ' has-error' : ''}}'>
                                {!!Form::label('nama','Nama',['class' => 'col-sm-2 control-label'])!!}
                                <div class="col-sm-10">
                                  {!!Form::text('nama',$aplikan->nama,['class' => 'form-control','placeholder' => 'Nama','required' => 'true'])!!}
                                  @if($errors->has('nama'))
                            ...
                            <div class='form-group{{$errors->has('jenis_kelamin') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::select('jenis_kelamin',[''=> 'Pilih Jenis Kelamin','P' => 'Pria','W' => 'Wanita'],$aplikan->jenis_kelamin,['class' => 'form-control'])!!}
                            ...
                            <div class='form-group{{$errors->has('tempat_lahir') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::text('tempat_lahir',$aplikan->tempat_lahir,['class' => 'form-control','placeholder' => 'Tempat Lahir'])!!}
                            ...
                            <div class='form-group{{$errors->has('tanggal_lahir') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::text('tanggal_lahir',$aplikan->tanggal_lahir,['class' => 'form-control','placeholder' => 'Tanggal Lahir','id' => 'tanggalLahir'])!!}
                            ...
                            <div class='form-group{{$errors->has('agama') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::text('agama',$aplikan->agama,['class' => 'form-control','placeholder' => 'Agama'])!!}
                                @if($errors->has('agama'))
                            ...
                            <div class='form-group{{$errors->has('email') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::email('email',$aplikan->email,['class' => 'form-control','placeholder' => 'Email','required' => 'true'])!!}
                                @if($errors->has('email'))
                            ...
                            <div class='form-group{{$errors->has('telepon') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::text('telepon',$aplikan->telepon,['class' => 'form-control','placeholder' => 'Telpon','required' => 'true'])!!}
                            ...
                            <div class='form-group{{$errors->has('village_id') ? ' has-error' : ''}}'>
                              ...
                              <div class="col-sm-10">
                                {!!Form::text('domisili',(\App\Kelurahan::find($aplikan->village_id) ? \App\Kelurahan::find($aplikan->village_id)->full() : ''),['class' => 'form-control','placeholder' => 'Ketik nama Kelurahan atau Kecamatan atau Kabupaten atau Provinsi','id' => 'domisili'])!!}
                                @if($errors->has('village_id'))
                                  <span class="help-block">{{$errors->first('village_id')}}</span>
                                @endif
                              </div>
                            </div>
                            <input type="hidden" name="village_id" value="{{$aplikan->village_id}}">
                            <div class='form-group{{$errors->has('alamat') ? ' has-error' : ''}}'>
                              {!!Form::label('alamat','Alamat',['class' => 'col-sm-2 control-label'])!!}
                              <div class="col-sm-10">
                                {!!Form::textarea('alamat',$aplikan->alamat,['class' => 'form-control','placeholder' => 'Alamat'])!!}
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content form-horizontal">
                          <div class='form-group{{$errors->has('asal_sekolah') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::text('asal_sekolah',$aplikan->asal_sekolah,['class' => 'form-control','placeholder' => 'Asal Sekolah'])!!}
                          ...
                          <div class='form-group{{$errors->has('jurusan_sekolah') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::text('jurusan_sekolah',$aplikan->jurusan_sekolah,['class' => 'form-control','placeholder' => 'Jurusan Sekolah'])!!}
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content form-horizontal">                          
                          <div class='form-group{{$errors->has('konsentrasi_id') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::select('konsentrasi_id',$konsentrasi->pluck('nama','id'),$aplikan->konsentrasi_id,['class' => 'form-control'])!!}
                          ...
                          <div class='form-group{{$errors->has('kelas_id') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::select('kelas_id',$kelasOptions,$aplikan->kelas_id,['class' => 'form-control'])!!}
                          ...
                          <div class='form-group{{$errors->has('pilihan_kampus_id') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::select('pilihan_kampus_id',$pilihanKampusOptions,$aplikan->pilihan_kampus_id,['class' => 'form-control'])!!}
                          ...
                          <div class='form-group{{$errors->has('sumber_informasi') ? ' has-error' : ''}}'>
                            ...
                            <div class="col-sm-10">
                              {!!Form::text('sumber_informasi',$aplikan->sumber_informasi,['class' => 'form-control','placeholder' => 'Sumber Informasi'])!!}
