        ...
        <div class="row">
            <div class="col-lg-3">
               <div class="ibox-content text-center">
                ...
                <a class="btn btn-primary followup" aplikan-id="{{$aplikan->id}}" data-toggle="modal" href='#followupModal'>Followup</a>
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    ...
                                                    <div class="media-body ">
                                                        <small class="pull-right">{{$fu->pivot->created_at->diffForHumans()}}</small>
                                                        <strong class="text-success">{{$aplikan->nama}}</strong> di follow up oleh <a href="#"><strong class="text-success">{{($fu->id == auth()->user()->id) ? 'Anda' : $fu->first_name}}</strong></a> . <br>
                                                        <small class="text-muted">{{$fu->pivot->created_at->format('d M y')}}</small>
                                                        <div class="well">
                                                            {{$fu->pivot->keterangan}}
                                                        </div>
