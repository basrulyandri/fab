          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins"> 
              <div class="ibox-content">
                ...
                <div class='form-group{{$errors->has('web_title') ? ' has-error' : ''}}'>                  
                   {!!Form::label('web_title','Web Title',['class' => 'col-sm-2 control-label'])!!}
                   <div class="col-sm-10">
                     {!!Form::text('web_title',getOption('web_title'),['class' => 'form-control','placeholder' => 'Web Title'])!!}
                     @if($errors->has('web_title'))
                     <span class="help-block">{{$errors->first('web_title')}}</span>
                     @endif
                   </div>
                 </div>                   
                 <div class='form-group{{$errors->has('web_description') ? ' has-error' : ''}}'>
                   {!!Form::label('web_description','Web Description',['class' => 'col-sm-2 control-label'])!!}
                   <div class="col-sm-10">
                     {!!Form::text('web_description',getOption('web_description'),['class' => 'form-control','placeholder' => 'Web Description'])!!}
                     @if($errors->has('web_description'))
                     <span class="help-block">{{$errors->first('web_description')}}</span>
                     @endif
                   </div>
                 </div>
